...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED_F_Pin LED_C_Pin LED_AC_Pin */
  GPIO_InitStruct.Pin = LED_F_Pin|LED_C_Pin|LED_AC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : F_Pin D_Pin C_Pin B_Pin
                           A_Pin */
  GPIO_InitStruct.Pin = F_Pin|D_Pin|C_Pin|B_Pin
                          |A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
